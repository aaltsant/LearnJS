    ...
    <div>
      ...
      <div className={styles.maincontainer}>
        ...
        <div className={styles.modecard}>
          ...
          <p className={styles.modepara}>
            Master the basics at your own pace. Practice with a vast library of questions ranging from variables to asynchronous patterns.
            Build your confidence and discover the correct answers without losing your streak.
            Perfect for learning without the pressure of a timer.
            </p>
        </div>
        ...
        <div className={styles.modecard}>
          ...
          <p className={styles.modepara}>
            Put your JS knowledge to the ultimate test! Answer 15 randomized questions.
            Build your streak by answering correctly in a row to multiply your score!
            Your performance will be ranked, so stay sharp and aim for the top of the leaderboard.
          </p>
        </div>
